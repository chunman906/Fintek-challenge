...
function countSquares(a, b) {
    const square = x => x * x;
    // 1. Find out how many pairs perfect squares between a and b.
    // 2. Create array of perfect squares.
    // 3. loop to check if each of square inisde the a and b.
    // 4. increase the counter and return it.
}
